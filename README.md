...
# 모든 AI 도구에 일괄 설치
npx skills add peachSolution/peach-harness --skill '*' --all
...
# 재설치로 업데이트 (권장)
npx skills add peachSolution/peach-harness --skill '*' -a claude-code -y
...
> **참고**: `npx skills update`는 프로젝트 스킬에 대한 버그가 있어 재설치(`npx skills add ... -y`)를 권장합니다.
